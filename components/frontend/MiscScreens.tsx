...
export const InboxScreen = ({ setScreen }: { setScreen: (s: string) => void }) => (
...
export const NotificationScreen = ({ setScreen }: { setScreen: (s: string) => void }) => (
  <View style={styles.whiteContainer}>
    <View style={styles.topPageHeader}>
      <TouchableOpacity onPress={() => setScreen('home')}>
        <ArrowLeft size={28} color="black" />
...
export const CreateEventScreen = ({
  ...
  boostEvent,
  setBoostEvent
}: Partial<MiscProps> & { setScreen: (s: string) => void }) => {
  return (
    <View style={styles.whiteContainer}>
